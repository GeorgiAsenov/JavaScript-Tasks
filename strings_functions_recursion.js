...
var name = "AnakinSkyewalker";

for (var index = 0; index < name.length; index++) {
    var result = name.toLowerCase().charAt(index);
    console.log(result)
}
...
function peinulka(omnre) {
    console.log('eat an ' + omnre);
    console.log('i don\'t like ' + omnre);
}
...
function anra(a, n) {
    return ((a == 0) || (n == 0)) ? 0 + ', to zero is not divisible!' : a / n;
